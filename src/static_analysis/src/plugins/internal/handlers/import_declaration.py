...
from src.plugins.internal.modeled_js_builtins import (
    setup_react_dom,
    setup_dom_purify,
    setup_markdown_it,
    setup_sanitize_html,
    ...
    if not source_file_path:
        ...
        for specifier_ast in specifier_list:
            ...
            for specifier_obj in specifier_obj_list:
                ...
                G.add_obj_to_name_node(
                    name_node=specifier_name_node,
                    ast_node=ast_node,
                    js_type=specifier_obj_type,
                    tobe_added_obj=specifier_obj,
                )
    else:
            ...
            if specifier_type == "AST_ImportDefaultSpecifier":
                ...
                if not module_export_default_objs:
                    ...
                    loggers.main_logger.warn(
                        f"Could not find export default obj, {imported_specifier_name} {module_exports_objs} {source_file_path} create_stub: {create_stub}"
                    )
