...
class PluginManager(object):
    ...
    class __PluginManager:
        ...
        from .internal.handlers.file import HandleToplevel as HandleToplevel
        ...
        from .internal.handlers.array import HandleArray as HandleArray, HandleArrayElem as HandleArrayElem
        ...
        def dispatch_node(self, node_id, extra=None):
            ...
            if self.G.is_statement(node_id):
                ...
                file_path = self.G.get_ast_node_file_path(node_id)
                loggers.main_logger.info(f"Running Line {line_mark[0]} to {line_mark[2]} {file_path}")
